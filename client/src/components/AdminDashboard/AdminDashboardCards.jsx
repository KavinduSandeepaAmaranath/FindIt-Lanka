    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-5 mb-8 sm:mb-10">
      {stats.map((item) => {
        ...
        return (
          <div
            key={item.title}
            className="bg-white/70 backdrop-blur-md border border-gray-200 rounded-2xl p-4 sm:p-5 shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-blue-500 hover:bg-white"
          >
            {/* Card Header */}
